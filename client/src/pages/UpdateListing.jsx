    ...
    <main className='p-3 max-w-4xl mx-auto'>
        ...
        <form  onSubmit={handleSubmit} className='flex flex-col sm:flex-row gap-4' >
            <div className='flex flex-col gap-4 flex-1'>
                <input type="text" placeholder='Name' id='name' className='border p-3  rounded-lg' required maxLength="62" minLength="10"
                 onChange={handleChange}
                 value={formData.name}/>

                <textarea placeholder='Description' id="description" className='border p-3 rounded-lg' required
                 onChange={handleChange}
            ...
            <div className='flex flex-col flex-1 gap-4'>
              ...
              {loading ? 'Editing...' : 'Edit listing'}</button>        
